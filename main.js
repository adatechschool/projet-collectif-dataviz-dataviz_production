...
function tokyoInfo() {
  ...
  document.getElementById("precipitations").innerHTML = "Rain " + data.t[3] + " Snow " + data.t[4];
  document.getElementById("sunPhases").innerHTML = "Sunrise " + data.t[7] + " Sunset " + data.t[8];
  document.getElementById("moonPhases").innerHTML = "Moonrise " + data.t[9] + " Moonset " + data.t[10];
};
function osakaInfo() {
  execute()
  document.getElementById("randomImage").innerHTML = `<img class = "cityImages" src=${data.randomPhotoUrl}>`
  document.getElementById("precipitations").innerHTML = "Rain " + data.o[3] + " Snow " + data.o[4];
  document.getElementById("sunPhases").innerHTML = "Sunrise " + data.o[7] + " Sunset " + data.t[8];
  document.getElementById("moonPhases").innerHTML = "Moonrise " + data.o[9] + " Moonset " + data.o[10];
};
function yokohamaInfo() {
  execute()
  document.getElementById("randomImage").innerHTML = `<img class = "cityImages" src=${data.randomPhotoUrl}>`
  document.getElementById("precipitations").innerHTML = "Rain " + data.y[3] + " Snow " + data.y[4];
  document.getElementById("sunPhases").innerHTML = "Sunrise " + data.y[7] + " Sunset " + data.y[8];
  document.getElementById("moonPhases").innerHTML = "Moonrise " + data.y[9] + " Moonset " + data.y[10];
};
function nagoyaInfo() {
  execute()
  document.getElementById("randomImage").innerHTML = `<img class = "cityImages" src=${data.randomPhotoUrl}>`
  document.getElementById("precipitations").innerHTML = "Rain " + data.n[3] + " Snow " + data.n[4];
  document.getElementById("sunPhases").innerHTML = " Sunrise " + data.n[7] + " Sunset " + data.n[8];
  document.getElementById("moonPhases").innerHTML = " Moonrise " + data.n[9] + " Moonset " + data.n[10];
};
function sapporoInfo() {
  execute()
  document.getElementById("randomImage").innerHTML = `<img class = "cityImages" src=${data.randomPhotoUrl}>`
  document.getElementById("precipitations").innerHTML = "Rain " + data.s[3] + " Snow " + data.s[4];
  document.getElementById("sunPhases").innerHTML = " Sunrise " + data.s[7] + " Sunset " + data.s[8];
  document.getElementById("moonPhases").innerHTML = " Moonrise " + data.s[9] + " Moonset " + data.s[10];
};
function fukuokaInfo() {
  execute()
  document.getElementById("randomImage").innerHTML = `<img class = "cityImages" src=${data.randomPhotoUrl}>`
  document.getElementById("precipitations").innerHTML = "Rain " + data.f[3] + " Snow " + data.f[4];
  document.getElementById("sunPhases").innerHTML = "Sunrise " + data.f[7] + " Sunset " + data.f[8];
  document.getElementById("moonPhases").innerHTML = "Moonrise " + data.f[9] + " Moonset " + data.f[10];
};
function kyotoInfo() {
  execute()
  document.getElementById("randomImage").innerHTML = `<img class = "cityImages" src=${data.randomPhotoUrl}>`
  document.getElementById("precipitations").innerHTML = "Rain " + data.ky[3] + " Snow " + data.ky[4];
  document.getElementById("sunPhases").innerHTML = "Sunrise " + data.ky[7] + " Sunset " + data.ky[8];
  document.getElementById("moonPhases").innerHTML = "Moonrise " + data.ky[9] + " Moonset " + data.ky[10];
};
function kobeInfo() {
  execute()
  document.getElementById("randomImage").innerHTML = `<img class = "cityImages" src=${data.randomPhotoUrl}>`
  document.getElementById("precipitations").innerHTML = "Rain " + data.ko[3] + " Snow " + data.ko[4];
  document.getElementById("sunPhases").innerHTML = "Sunrise " + data.ko[7] + " Sunset " + data.ko[8];
  document.getElementById("moonPhases").innerHTML = "Moonrise " + data.ko[9] + " Moonset " + data.ko[10];
};
